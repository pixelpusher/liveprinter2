...
it.notes = ['c4', 'd2', 'g4','c4', 'd3', 'g4','c4', 'd4', 'g4'];
...
# bail false | prime | speed 80 | mov2 it.next() | unretract | wait 20 | fan 10
...
const nextnote = makenext(notes);  
  
const durs = ['1/4b', '2b', '1b', '1/2b', '1/2b', '1/4b', '1/2b', '1/4b'];  
  
const nextdur = makenext(durs);
...
repeat(128, async ()=> {
  # speed nextnote() | drawtime nextdur() | turn (360/12) | elev (Math.PI/88)
...
repeat(64, async ()=> {
  ...
  # speed nextnote() | traveltime nextdur() | turn (360/6) | elev (Math.PI/48)
//  await (() => new Promise((resolve) => setTimeout(resolve, delaytime)))();
  console.log(\`\${c++}\`);
  if (bail) return;
})
